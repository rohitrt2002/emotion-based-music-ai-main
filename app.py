...
haarcascade = "D:\Dowload\emotion-based-music-ai-main\emotion-based-music-ai-main/haarcascade_frontalface_default.xml"
label_map = ['Anger', 'Neutral', 'Fear', 'Happy', 'Sad', 'Surprise']
print("+"*50, "loadin gmmodel")
model = load_model('D:\Dowload\emotion-based-music-ai-main\emotion-based-music-ai-main/model.h5')
